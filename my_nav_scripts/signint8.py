...
class SignDetectionNode(Node):
    def __init__(self):
        ...
        MODEL_PATH = '/home/garygay/autorace_ws/src/my_nav_scripts/weights/bestint8.tflite'
        
        self.CONFIDENCE_THRESHOLD = 0.7 # 你已調整
        self.NMS_IOU_THRESHOLD = 0.4
        self.DRAW_OUTPUT = False # 保持為 False，以測試核心性能
        ...
        try:
            ...
            self.output_details = self.interpreter.get_output_details() # 獲取輸出詳情以備後用
            ...
            # self.output_tensor_index = self.output_details[0]['index'] # 這行可以保留，或者直接用 self.output_details[0]['index']
