...
<p align="center"> <img src="Pics/Detect Result.png" width="60%"> </p>
...
<p align="center"> <img src="Pics/Converted.png" width="60%"> <br> <em>模型轉換流程示意：由 YOLOv5 → ONNX → TensorFlow → TFLite (INT8)</em> </p> 
...
<p align="center"> <img src="Pics/Lane Detection.png" width="60%"> <br>對「黃色」部分，我們將 Hue（色調） 設定得較嚴格，以避免受到光線影響。<br> <em>對「白色」部分，則對 Saturation（飽和度） 與 Value（亮度） 的限制較嚴格。</em> </p> 
...
<p align="center"> <img src="Pics/Lane Detection.png" width="100%"></p> 
黃色遮罩：專注於 ROI 的左半部； 
白色遮罩：專注於 ROI 的右半部。 
...
系統同時整合多個 ROS Topic：
<p align="center"> <img src="Pics/Scan.png" width="40%"> <br> <em>/scan：用於避障、停車與黑箱區判斷。</em></p> 
<p align="center"> <img src="Pics/Odom.png" width="40%"> <br> <em>/odom：提供機器人的位置與朝向資訊，支援精確控制行進距離與旋轉角度。</em> </p> 

## 🧭 導航功能 (Navigation)
<p align="center"> <img src="Pics/Navigation.png" width="50%"> </p>  
